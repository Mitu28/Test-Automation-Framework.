...
public class LoginPage extends BrowserUtility {
	...
	public String getErrorMessage() {
	    ...
	    wait.until(ExpectedConditions.visibilityOfElementLocated(ERROR_MESSAGE_LOCATOR));
	    return getVisibleText(ERROR_MESSAGE_LOCATOR);  // Using getVisibleText to fetch the error message
	}
}
